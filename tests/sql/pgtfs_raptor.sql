...
select
    ...
    arrival_time,
    trip_id
from pgtfs_raptor('10017', '51607', 1712707200.0, NULL);
...
-- check that same route is prioritized 
...
-- check that the route is not generated if the max_rounds parameter is too low 
